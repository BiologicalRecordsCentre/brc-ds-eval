(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3'), require('util')) :
  typeof define === 'function' && define.amd ? define(['exports', 'd3', 'util'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.brcdseval = {}, global.d3, global.util));
}(this, (function (exports, d3, util) { 'use strict';
  ...
  var markdown = createCommonjsModule(function (module, exports) {
   ...
   // 4 spaces + content
      ...
      function extract_attr(jsonml) {
        return isArray(jsonml) && jsonml.length > 1 && _typeof$1(jsonml[1]) === "object" && !isArray(jsonml[1]) ? jsonml[1] : undefined;
      }
      /**
      ...
      expose.renderJsonML = function (jsonml, options) {
        ...
        if (options.root) {
          ...
          if (jsonml.length && _typeof$1(jsonml[0]) === "object" && !(jsonml[0] instanceof Array)) {
